...
export const loader: LoaderFunction = async (data) => {
  ...
  return await api(data, `/applicant-profile/${params.id}`)
}
...
const Profile = () => {
  const profile: ApplicantProfile = useLoaderData()
      ...
      <main className="py-10">
        ...
        <div className="md:flex md:items-center md:justify-between">
          ...
          <div className="justify-stretch mt-6 flex flex-col-reverse space-y-4 space-y-reverse sm:flex-row-reverse sm:justify-end sm:space-y-0 sm:space-x-3 sm:space-x-reverse md:mt-0 md:flex-row md:space-x-3">
            <Button type="submit" color="secondary" text="Disqualify" />
            <Button type="submit" color="primary" text="Advance to offer" />
          </div>
        </div>
                    ...
                    <div className="min-w-0 flex-1">
                      <form action="#">
                        ...
                        <div className="mt-3 flex items-center justify-between">
                          ...
                          <Button type="submit" color="primary" text="Comment" />
                        </div>
                      </form>
                    </div>
                  </div>
          ...
          <section aria-labelledby="timeline-title" className="lg:col-span-1 lg:col-start-3">
            <div className="bg-white px-4 py-5 shadow sm:rounded-lg sm:px-6">
              ...
              <div className="justify-stretch mt-6 flex flex-col">
                <Button type="submit" width="full" text="Advance to offer" />
              </div>
            </div>
          </section>
        </div>
