...
import type { StageInPipeline } from '~/models/positions/Stage'

type Props = {
  stages: StageInPipeline[]
  currentStageIndex: number
  onChange?: Function
}

const StageAdvance: React.FC<Props> = ({ stages, currentStageIndex, onChange = () => {} }) => {
  const [selected, setSelected] = useState(stages[currentStageIndex].stageId)
  ...
  const currentStage = stages.filter((stageInPipeline: StageInPipeline) => stageInPipeline.stageId === selected).pop()
